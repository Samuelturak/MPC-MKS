...
void StartVisualTask(void const * argument)
{
	...
	for(;;)
	{
		...
		//			if (msg < -1000)
		//			{
		//				HAL_GPIO_WritePin(LED1_GPIO_Port, LED1_Pin, 0); // turning LED on
		//				HAL_GPIO_WritePin(LED2_GPIO_Port, LED2_Pin, 1); // turning LED off
		//			}
		//
		//			else if (msg > 1000)
		//			{
...
void StartAcceleroTask(void const * argument)
{
	...
	//	printf("LIS2DW12_ID %s\n", (whoamI == LIS2DW12_ID) ? "OK" : "FAIL"); // printing for testing
...
//	static const int16_t msg[4] = {-5000, 0, 5000, 0};
//
//	for(;;)
//	{
//
